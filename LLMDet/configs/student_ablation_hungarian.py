# Matching-ablation ARM hungarian: see build_ablation_odvg.py
...
# performance. 4-GPU launch: bash dist_train.sh configs/student_ablation_hungarian.py 4 --amp
# LR note: see student_llmstu_exact.py (auto_scale_lr handles global batch 8).

_base_ = ['./grounding_dino_swin_t_student_only.py']

arm_train_ann = '../llmstu_tools/outputs/odvg_ablation_hungarian.jsonl'
