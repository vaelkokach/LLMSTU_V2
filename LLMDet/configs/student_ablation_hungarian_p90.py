# Matching-ablation ARM hungarian_p90: see build_ablation_odvg.py
# Same frames/captions/boxes as the other arms; only the assignment differs.
# Short schedule — the arms compare label-assignment quality, not final
# performance. 4-GPU launch: bash dist_train.sh configs/student_ablation_hungarian_p90.py 4 --amp
# LR note: see student_llmstu_exact.py (auto_scale_lr handles global batch 8).

_base_ = ['./grounding_dino_swin_t_student_only.py']

arm_train_ann = '../llmstu_tools/outputs/odvg_ablation_hungarian_p90.jsonl'
